...
def upload_file_to_hanwang(file_path, server_url="http://192.168.31.230:9310/files"):
    """
    上传文件到汉王服务器
...
def main():
    ...
    try:
        ...
        result = upload_file_to_hanwang(file_path)

        print("上传成功!")
        print(f"文件名: {result['filename']}")
        print(f"编码后文件名: {result['encoded_filename']}")
