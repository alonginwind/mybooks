...
/***/},
/***/68:
/***/(e,t,s)=>{var n,o,i,a,r,d,l,c=s(263),h=s(499),m=Function.prototype.apply,g=Function.prototype.call,u=Object.create,b=Object.defineProperty,p=Object.defineProperties,f=Object.prototype.hasOwnProperty,w={configurable:!0,enumerable:!1,writable:!0};o=function(e,t){var s,o;return h(t),o=this,n.call(this,e,s=function(){i.call(o,e,s),m.call(t,this,arguments)}),s.__eeOnceListener__=t,this},r={on:n=function(e,t){var s;return h(t),f.call(this,"__ee__")?s=this.__ee__:(s=w.value=u(null),b(this,"__ee__",w),w.value=null),s[e]?"object"==typeof s[e]?s[e].push(t):s[e]=[s[e],t]:s[e]=t,this},once:o,off:i=function(e,t){var s,n,o,i;if(h(t),!f.call(this,"__ee__"))return this;if(!(s=this.__ee__)[e])return this;if("object"==typeof(n=s[e]))for(i=0;o=n[i];++i)o!==t&&o.__eeOnceListener__!==t||(2===n.length?s[e]=n[i?0:1]:n.splice(i,1));else n!==t&&n.__eeOnceListener__!==t||delete s[e];return this},emit:a=function(e){var t,s,n,o,i;if(f.call(this,"__ee__")&&(o=this.__ee__[e]))if("object"==typeof o){for(s=arguments.length,i=new Array(s-1),t=1;t<s;++t)i[t-1]=arguments[t];for(o=o.slice(),t=0;n=o[t];++t)m.call(n,this,i)}else switch(arguments.length){case 1:g.call(o,this);break;case 2:g.call(o,this,arguments[1]);break;case 3:g.call(o,this,arguments[1],arguments[2]);break;default:for(s=arguments.length,i=new Array(s-1),t=1;t<s;++t)i[t-1]=arguments[t];m.call(o,this,i)}}},d={on:c(n),once:c(o),off:c(i),emit:c(a)},l=p({},d),e.exports=t=function(e){return null==e?u(l):p(Object(e),d)},t.methods=r},
/***/80:
...
/**
 * UIDiv
 */class g extends h{constructor(){super("div")}}
/**
 * UIRow
 */class u extends g{constructor(){super(),this.dom.className="row"}}
/**
 * UIPanel
 */class b extends g{constructor(){super(),this.dom.className="panel"}}
/**
 * UILabel
 * @param {string} text
 * @param {string} id
 ...
 * UISelect
 */
class k extends h{constructor(){super("select")}setMultiple(e){return this.dom.multiple=e||!1,this}setOptions(e){const t=this.dom.value;this.clear();for(const t in e){const s=document.createElement("option");s.value=t,s.text=e[t],this.dom.appendChild(s)}return this.dom.value=t,this}getValue(){return this.dom.value}setValue(e){return e=String(e),this.dom.value!==e&&(this.dom.value=e),this}}
/**
 * UIInput
 * @param {*} type
 * @param {*} value
 * @param {*} title
 */class v extends h{constructor(e,t,s){super("input"),this.dom.type=e,this.dom.onkeydown=e=>{e.stopPropagation()},this.setValue(t),this.setTitle(s)}getName(){return this.dom.name}setName(e){return this.dom.name=e,this}getType(){return this.dom.type}setType(e){return this.dom.type=e,this}getValue(){return this.dom.value}setValue(e){return this.dom.value!==e&&void 0!==e&&(this.dom.value=e),this}}
/**
 * UIColor
 */
/**
 ...
 */
class x extends g{constructor(e){super(),this.align=e||"horizontal",this.tabs=[],this.panels=[],this.selector=(new m).setClass("tab-selector"),this.menuDiv=(new g).setClass("menu"),this.tabsDiv=(new g).setClass("tabs"),this.tabsDiv.add(this.selector),this.panelsDiv=(new g).setClass("panels"),this.selected="",this.add(this.menuDiv),this.add(this.tabsDiv),this.add(this.panelsDiv)}addMenu(e){this.menuDiv.add(e)}addTab(e,t,s){const n=new C(t,this);n.setId(e),n.setClass("box"),this.tabs.push(n),this.tabsDiv.add(n);const o=new g;o.setId(e),o.add(s),this.panels.push(o),this.panelsDiv.add(o),this.select(e)}select(e){for(let t of this.tabs)t.dom.id===e?(t.addClass("selected"),this.transformSelector(t)):t.dom.id===this.selected&&t.removeClass("selected");for(let t of this.panels)t.dom.id===e?t.dom.style.display="block":t.dom.id===this.selected&&(t.dom.style.display="none");return this.selected=e,this}setLabel(e,t){for(let s of this.tabs)if(s.dom.id===e){s.setTitle(t);break}}transformSelector(e){let t;const s=e.getBoundingClientRect();"horizontal"===this.align?(t=s.width*this.tabs.indexOf(e),this.selector.dom.style.transform=`translateX(${t}px)`):(t=s.height*this.tabs.indexOf(e),this.selector.dom.style.transform=`translateY(${t}px)`)}}
/**
 * UITab
 * @param {string} text
 * @param {UITabbedPanel} parent
 */class C extends g{constructor(e,t){super(),this.button=new v("button"),this.button.dom.title=e,this.dom.onclick=e=>{t.select(this.dom.id),e.preventDefault()},this.add(this.button)}}
/**
 * UIList
 * @param {UIItem} parent
...
this.selected=!1}add(){let e=0;const t=(new g).setId("item-box");for(let s=0;s<arguments.length;s++){const n=arguments[s];n instanceof S?super.add(n):(t.add(n),e++)}return e&&super.add(t),this}select(){return this.selected=!0,this.setClass("selected"),this}unselect(){return this.selected=!1,this.removeAttribute("class"),this}}
/**
 * UIBox
 * @param {UIElement} items
 */class D extends h{constructor(e){super("div"),this.setClass("box"),this.add(e)}}// ./src/toolbar.js
class T{constructor(e){const t=e.strings,s=e.settings;this.isMobile=r();const n=(new g).setId("toolbar"),o=["toolbar/sidebar","toolbar/prev","toolbar/next","toolbar/openbook","toolbar/openbook/error","toolbar/bookmark","toolbar/fullscreen","toolbar/close"],i=(new g).setClass("menu-1"),a=(new g).setId("btn-m").setClass("box"),d=new v("button");let l,c,h,m;d.dom.title=t.get(o[0]),d.dom.onclick=t=>{e.emit("sidebaropener",!0),d.dom.blur(),t.preventDefault()},a.add(d),i.add(a),"toolbar"===s.arrows&&(l=(new g).setId("btn-p").setClass("box"),c=new v("button"),c.setTitle(t.get(o[1])),c.dom.onclick=t=>{e.emit("prev"),t.preventDefault(),c.dom.blur()},l.add(c),i.add(l),h=(new g).setId("btn-n").setClass("box"),m=new v("button"),m.dom.title=t.get(o[2]),m.dom.onclick=t=>{e.emit("next"),t.preventDefault(),m.dom.blur()},h.add(m),i.add(h));const u=(new g).setClass("menu-2");let b,p,f,w;if(s.openbook){const s=t=>{e.storage.clear(),e.storage.set(t.target.result,(()=>{e.unload(),e.init(t.target.result);const s=new URL(window.location.origin);window.history.replaceState({},"",s)}))},n=e=>{console.error(e)},i=(new g).setId("btn-o").setClass("box");b=new v("file"),b.dom.title=t.get(o[3]),b.dom.accept="application/epub+zip",b.dom.onchange=e=>{if(0!==e.target.files.length)if(window.FileReader){const t=new FileReader;t.onload=s,t.readAsArrayBuffer(e.target.files[0]),t.onerror=n}else alert(t.get(o[4]))},b.dom.onclick=e=>{b.dom.blur()},i.add(b),u.add(i)}if(s.bookmarks&&(p=(new g).setId("btn-b").setClass("box"),f=new v("button"),f.setTitle(t.get(o[6])),f.dom.onclick=t=>{const s=this.locationCfi,n=-1===e.isBookmarked(s);e.emit("bookmarked",n),t.preventDefault(),f.dom.blur()},p.add(f),u.add(p)),s.fullscreen){const e=(new g).setId("btn-f").setClass("box");w=new v("button"),w.setTitle(t.get(o[6])),w.dom.onclick=e=>{this.toggleFullScreen(),e.preventDefault()},document.onkeydown=e=>{"F11"===e.key&&(e.preventDefault(),this.toggleFullScreen())},document.onfullscreenchange=t=>{const s=window.screen.width===t.target.clientWidth,n=window.screen.height===t.target.clientHeight;s&&n?e.addClass("resize-small"):e.removeClass("resize-small")},e.add(w),u.add(e)}if(this.isMobile){let e,s;console.log("Mobile device detected, hiding spread and pagination options."),e=(new g).setId("btn-e").setClass("box"),s=new v("button"),s.setTitle(t.get(o[7])),s.dom.onclick=e=>{
// Close the reader on mobile devices
window.history.back(),e.preventDefault(),s.dom.blur()},e.add(s),u.add(e)}const k=(new g).setClass("menu-center"),y=(new g).setClass("chapter-title");k.add(y),n.add([i,k,u]),document.body.appendChild(n.dom),
//-- events --//
...
class B{constructor(e){const t=e.settings,s=(new g).setId("content");let n;"content"===t.arrows&&(n=(new g).setId("prev").setClass("arrow"),n.dom.onclick=t=>{e.emit("prev"),t.preventDefault()},n.add(new m("<")),s.add(n));const o=(new g).setId("viewer");let i;s.add(o),"content"===t.arrows&&(i=(new g).setId("next").setClass("arrow"),i.dom.onclick=t=>{e.emit("next"),t.preventDefault()},i.add(new m(">")),s.add(i));const a=(new g).setId("loader"),r=(new g).setId("divider"),d=(new g).setId("overlay");d.dom.onclick=t=>{e.emit("sidebaropener",!1),t.preventDefault()},s.add([a,r,d]),document.body.appendChild(s.dom),o.setClass(t.flow),
//-- events --//
...
class O extends b{constructor(e){super();const t=(new g).setClass("list-container"),s=e.strings,n=["sidebar/contents"],o=new w(s.get(n[0])).setClass("label");this.reader=e,this.selector=void 0,// save reference to selected tree item
...
class _ extends b{constructor(e){super();const t=(new g).setClass("list-container"),s=e.strings,n=["sidebar/bookmarks","sidebar/bookmarks/clear"],o=new w(s.get(n[0])).setClass("label"),i=new v("button",s.get(n[1]));i.dom.onclick=t=>{this.clearBookmarks(),e.emit("bookmarked",!1),t.preventDefault()},this.add(new D([o,i]).addClass("header")),this.selector=void 0,this.bookmarks=new S,t.add(this.bookmarks),this.setId("bookmarks"),this.add(t),this.reader=e;const a=()=>{i.dom.disabled=0===e.settings.bookmarks.length};
//-- events --//
...
class z extends b{constructor(e){super();const t=(new g).setClass("list-container"),s=e.strings,n=["sidebar/annotations","sidebar/annotations/clear"],o=new w(s.get(n[0])).setClass("label"),i=new v("button",s.get(n[1]));i.dom.onclick=e=>{this.clearNotes(),e.preventDefault()},this.add(new D([o,i]).addClass("header")),this.selector=void 0,this.notes=new S,t.add(this.notes),this.setId("annotations"),this.add(t),this.reader=e,this.update=()=>{i.dom.disabled=0===e.settings.annotations.length},
//-- events --//
...
class F extends b{constructor(e){super(),super.setId("settings");const t=e.strings,s=["sidebar/settings","sidebar/settings/language","sidebar/settings/fontsize","sidebar/settings/flow","sidebar/settings/spread","sidebar/settings/spread/minwidth","sidebar/settings/theme"],n=new w(t.get(s[0])).setClass("label");this.add(new D(n).addClass("header"));const o=new p(t.get(s[1]),"language-ui"),i=new u,a=(new k).setOptions({zh:"中文",en:"English"});a.dom.onchange=t=>{e.emit("languagechanged",t.target.value)},a.setId("language-ui"),i.add(o),i.add(a);const r=new p(t.get("sidebar/settings/theme"),"theme"),d=new u,l=(new k).setOptions({light:t.get("sidebar/settings/theme/items")[0],dark:t.get("sidebar/settings/theme/items")[1],eyecare:t.get("sidebar/settings/theme/items")[2]});l.dom.onchange=t=>{e.emit("themechanged",t.target.value)},l.setId("theme"),d.add(r),d.add(l);const c=new p(t.get("sidebar/settings/font"),"font"),h=new u,m=(new k).setOptions({default:t.get("sidebar/settings/font/default"),"FZSongKeBenXiuKaiS-R-GB":"方正宋刻本秀楷","Huiwen-HKHei":"汇文港黑","Huiwen-Fangsong":"汇文仿宋体",Bookerly:"Bookerly"});m.dom.onchange=t=>{e.emit("styleschanged",{font:t.target.value})},m.setId("font"),h.add(c),h.add(m);const g=new p(t.get(s[2]),"fontsize"),b=new u,f=new y(100,1);f.dom.onchange=t=>{e.emit("styleschanged",{fontSize:parseInt(t.target.value)})},f.setId("fontsize"),b.add(g),b.add(f);
//-- flow configure --//
const x=new p(t.get(s[3]),"flow"),C=new u,S=t.get("sidebar/settings/pagination"),I=(new k).setOptions({paginated:S[0],scrolled:S[1]});I.dom.onchange=t=>{e.emit("flowchanged",t.target.value),"scrolled"===t.target.value?(z.setValue("none"),z.dom.disabled=!0,T.dom.disabled=!0,e.emit("spreadchanged",{mod:"none",min:void 0})):(z.setValue("auto"),z.dom.disabled=!1,T.dom.disabled=!1,e.emit("spreadchanged",{mod:"auto",min:void 0}))},I.setId("flow"),C.add(x),C.add(I);
//-- spdead configure --//
const T=new y(800,1),B=new p(t.get(s[4]),"spread"),O=new u,_=t.get("sidebar/settings/spread/items"),z=(new k).setOptions({none:_[0],auto:_[1]});z.dom.onchange=t=>{e.emit("spreadchanged",{mod:t.target.value,min:void 0}),T.dom.disabled="none"===t.target.value},z.setId("spread"),O.add(B),O.add(z);const V=new p(t.get(s[5]),"min-spread-width"),F=new u;T.dom.onchange=t=>{e.emit("spreadchanged",{mod:void 0,min:parseInt(t.target.value)})},T.setId("min-spread-width"),F.add(V),F.add(T);
//-- pagination --//
const A=t.get("sidebar/settings/pagination"),P=new u,j=new v("checkbox",!1,A[1]);j.setId("pagination"),j.dom.onclick=e=>{},P.add(new p(A[0],"pagination")),P.add(j),this.add(new D([i,d,h,b,C,O,F])),
//-- events --//
...
class P{constructor(e){const t=e.strings,s=e.settings,n=["sidebar/close","sidebar/contents","sidebar/bookmarks","sidebar/annotations","sidebar/search","sidebar/settings","sidebar/metadata"],o=new x("vertical").setId("sidebar"),i=(new g).setId("btn-p").addClass("box"),a=new v("button");a.setTitle(t.get(n[0])),a.dom.onclick=t=>{e.emit("sidebaropener",!1),t.preventDefault(),a.dom.blur()},i.add(a),o.addMenu(i),o.addTab("btn-t",t.get(n[1]),new O(e)),s.bookmarks&&o.addTab("btn-d",t.get(n[2]),new _(e)),s.annotations&&o.addTab("btn-a",t.get(n[3]),new z(e)),o.addTab("btn-s",t.get(n[4]),new V(e)),o.addTab("btn-c",t.get(n[5]),new F(e)),o.addTab("btn-i",t.get(n[6]),new A(e)),o.select("btn-t"),document.body.appendChild(o.dom),
//-- events --//
...
buildFontUrl(e){return`${window.location.origin+window.location.pathname.replace(/\/[^\/]*$/,"/")}${this.settings.assetsPath?this.settings.assetsPath+"/":""}assets/font/${e}`}applyUITheme(e){document.body.className="dark"===e?"dark-theme":"eyecare"===e?"eyecare-theme":""}applyStyles(){if(!this.rendition)return;const e=this.settings.theme,t="default"===this.settings.styles.font?"":this.settings.styles.font,s=t=>{let s={};const n="reader-theme",o={"Huiwen-HKHei":"HuiwenGangHei","Huiwen-Fangsong":"HuiwenFangSong","FZSongKeBenXiuKaiS-R-GB":"FangzhengSongJianKe",Bookerly:"Bookerly-Regular"}[t]||t,i=this.buildFontUrl(`${o}.ttf`),a=(e,t)=>(e["font-family"]=t?t+" !important":"Bookerly !important",e);s="dark"===e?{"@font-face":{"font-family":t||"Bookerly",src:`url(${i}) format('truetype')`,"font-weight":"normal","font-style":"normal"},body:a({background:"#1a1a1a",color:"#e0e0e0 !important"},t),p:a({color:"#e0e0e0 !important"},t),"h1, h2, h3, h4, h5, h6":a({color:"#e0e0e0 !important"},t),div:a({},t),span:a({},t),a:a({color:"#4a9eff !important"},t),"a:visited":{color:"#b19cd9 !important"}}:"eyecare"===e?{"@font-face":{"font-family":t||"Bookerly",src:`url(${i}) format('truetype')`,"font-weight":"normal","font-style":"normal"},body:a({background:"#f0f4e8",color:"#2d4a2d !important"},t),p:a({color:"#2d4a2d !important"},t),"h1, h2, h3, h4, h5, h6":a({color:"#2d4a2d !important"},t),div:a({},t),span:a({},t),a:a({color:"#4a7c4a !important"},t),"a:visited":{color:"#6b8e6b !important"}}:{"@font-face":{"font-family":t||"Bookerly",src:`url(${i}) format('truetype')`,"font-weight":"normal","font-style":"normal"},body:a({background:"#fff",color:"#000 !important"},t),p:a({color:"#000 !important"},t),"h1, h2, h3, h4, h5, h6":a({color:"#000 !important"},t),div:a({},t),span:a({},t),a:a({color:"#1a73e8 !important"},t),"a:visited":{color:"#8e24aa !important"}},this.rendition.themes.register(n,s),this.rendition.themes.select(n),this.rendition.themes.font(t||"Bookerly")};s(t||"")}navItemFromCfi(e){
